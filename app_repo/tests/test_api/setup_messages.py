...
def mock_all_messages(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.api.messages.db_manager.get_all_messages", setup_all_messages
    )
...
def mock_message_2(monkeypatch):
    ...
    monkeypatch.setattr("app.api.messages.db_manager.get_message", setup_message_2)
...
def mock_messages_scores(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.api.messages.db_manager.get_messages_scores", setup_messages_scores
    )
...
def mock_message_2_score(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.api.messages.db_manager.get_message_score", setup_message_score
    )
...
def mock_filtered_scores(monkeypatch):
    ...
    monkeypatch.setattr(
        "app.api.messages.db_manager.filter_messages_scores", setup_filtered_scores
    )
